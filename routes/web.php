...
Route::get('test/delete/{id}', array('as' => 'admin.test.delete', 'uses' => 'Admin\TestController@delete'));
Route::get('test/statuschange/{id}', array('as' => 'admin.test.statuschange', 'uses' => 'Admin\TestController@statuschange'));
