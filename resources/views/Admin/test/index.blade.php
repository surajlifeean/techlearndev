...
<section class="scrollable padder">
 ...
 <ul class="breadcrumb no-border no-radius b-b b-light pull-in">
                ...
                <li><a href="{{route('course-management.index')}}">Test Management</a></li>
                <li><a href="{{route('course-management.index')}}">list</a></li>
               
              </ul>

 
                      <header class="panel-heading">
                        <span class="h4">Test Listing</span>
                      </header>
                  ...
                  <div class="row m-t-sm">
                    <div class="col-sm-8 m-b-xs">
                      ...
                      <div class="btn-group">
                       <a href="{{route('test.index')}}"> <button type="button" class="btn btn-sm btn-default" title="Refresh"><i class="fa fa-refresh"></i></button></a>
                  ...
                  <a href="javascript:void(0)" class="inactive-status" aria-label="Left Align" onclick="changebulkstatus('I')"  title="Activate course">
                      ...
                      <a href="{{route('question.index')}}" class="btn btn-sm btn-default"><i class="fa fa-plus"></i>Add New Test</a>
                    </div>
...
<!--                     <form action="{{route('course-search')}}" method="get">
           ...
           <a href="javascript:void(0)" class="active-status" aria-label="Left Align" onclick="changestatus('A',{{$value->id}})" data-toggle="tooltip" title="Deactivate Product">
                  ...
                  <button class="btn btn-primary btn-rounded formConfirm" data-form="#frmStatus-{{$value->id}}" data-title="Status Change" data-message="Are you sure, you want to change the status ?" >
                                    ...
                                    {!! Form::open(array(
                                            'url' => route('admin.test.statuschange', array($value->id)),
                                            'method' => 'get',
                                            'style' => 'display:none',
                     ...
                     {!! Html::LinkRoute('course-management.edit',null,array($value->id),array('class'=>"fa fa-pencil-square-o",'data-toggle'=>"tooltip",'title'=>"Edit Course"))!!} -->
                      <a href="{{route('exam-list.edit',$value->id)}}" class="btn btn-info btn-rounded"><i class="fa fa-pencil-square-o"></i></a>
                        ...
                        <button class="btn btn-danger btn-rounded formConfirm" data-form="#frmDelete-{{$value->id}}" data-title="Delete banner" data-message="Are you sure, you want to delete this course ?" >
                                    ...
                                    {!! Form::open(array(
                                            'url' => route('admin.test.delete', array($value->id)),
                                            'method' => 'get',
                                            'style' => 'display:none',
...
<div> Showing {!!$test->count()!!}|{!!$test->total()!!}</div>
