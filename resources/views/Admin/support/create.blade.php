              ...
              <ul class="breadcrumb no-border no-radius b-b b-light pull-in">
                ...
                <header class="panel-heading">
                  <span class="h4">Add Support</span>
                      ...
                      {{Form::open(['route' => 'support-management.store','files' => true, 'class'=>'form-horizontal course-form','data-parsley-validate'])}}
                      ...
                      <div class="panel-body">                   
                        ...
                        <div class="form-group">
                          <label class="col-sm-3 control-label"> Details</label>
                            <div class="col-sm-9">                           
                              <textarea name="limitedtextarea"  class="form-control" onKeyDown="limitText(this.form.limitedtextarea,this.form.countdown,100);"onKeyUp="limitText(this.form.limitedtextarea,this.form.countdown,100);">
                              </textarea><br>
