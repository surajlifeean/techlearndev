...
<section class="scrollable padder">
 ...
 <ul class="breadcrumb no-border no-radius b-b b-light pull-in">
                ...
                <li><a href="{{route('course-management.create')}}">Add Review</a></li>
                      ...
                      {{Form::open(['route' => 'review-management.store','files' => true, 'class'=>'form-horizontal course-form','data-parsley-validate'])}}
...
<!--                             <input type="text" name="title" class="form-control"  data-required="true" placeholder="Course Title" required> -->   
                         ...
                         <div class="form-group">
                          ...
                          <div class="col-sm-9">
                            <input type="text" name="review_by" class="form-control"  data-required="true" placeholder="Course Review" required>   
                          </div>
                        </div>
                      ...
                      <!--   <div class="form-group">
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-sm-9">
                            ...
                            <textarea id="summernote" name="comment" class="form-control" required></textarea> 
                          </div>
                        </div>
