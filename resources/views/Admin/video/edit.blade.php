...
<section class="scrollable padder">
 ...
 <ul class="breadcrumb no-border no-radius b-b b-light pull-in">
                ...
                <li><a href="{{route('video-management.index')}}">Video Management</a></li>
                      ...
                      <header class="panel-heading">
                        <strong>Edit The Video Details</strong>
                      </header>
                      <!-- {{Form::open(['route' => 'video-management.store','files' => true, 'class'=>'form-horizontal course-form','data-parsley-validate'])}} -->
                      {{Form::model($videos,['route'=>['video-management.update',$videos->id],'method'=>'PUT','files' => true, 'class'=>'form-horizontal course-form','data-parsley-validate'])}}
                      <div class="panel-body">                   
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-sm-9">
                            <input type="url" name="video_link" class="form-control" value="{!!($videos->video_link)!!}"  data-required="true" placeholder="Video Link" required>   
                          </div>
                        </div>
                  ...
                  <footer class="panel-footer text-right bg-light lter">
                        ...
                        <a href="{{url('/admin/video-management')}}" class="btn btn-danger">Cancel</a>
                      </footer>
