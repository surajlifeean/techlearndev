...
<section class="banner-sleek" style="background-image:url({{$img}}); background-size: cover;">
  <div class="banner-text text-center">
    <div class="banner-container">
      ...
      <p> The interactive learning destination for aspiring and <br>
  ...
  <div class="container">
	...
	<div class="course-description row mt-5">
	  	<div class="col-md-8">
			...
			<p>
				Welcome to my comprehensive course on Ethical Hacking! In this course, you will start as a beginner with no previous knowledge about penetration testing or hacking. The first thing you will learn is some basic information about ethical hacking and the different fields in
penetration testing.
  <br>
